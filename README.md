cub3D is a project that will require to make a semi-3D game using the raycasting engine, which is the same engine that Wolfenstein 3D the first ever FPS game used.
